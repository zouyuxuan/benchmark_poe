...
//! HOSTNAME: `zyxdeMacBook-Air.local`, CPU: `<UNKNOWN>`
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn create_claim(d: u32, ) -> Weight {
		Weight::from_ref_time(18_000_000 as u64)
			// Standard Error: 179
			.saturating_add(Weight::from_ref_time(4_927 as u64).saturating_mul(d as u64))
	...
	fn revoke_claim(d: u32, ) -> Weight {
		Weight::from_ref_time(18_000_000 as u64)
			// Standard Error: 252
			.saturating_add(Weight::from_ref_time(14_152 as u64).saturating_mul(d as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
	// Storage: PoeModule Proofs (r:1 w:1)
	...
	fn transfer_claim(d: u32, ) -> Weight {
		Weight::from_ref_time(13_000_000 as u64)
			// Standard Error: 129
			.saturating_add(Weight::from_ref_time(10_606 as u64).saturating_mul(d as u64))
			.saturating_add(T::DbWeight::get().reads(1 as u64))
			.saturating_add(T::DbWeight::get().writes(1 as u64))
	}
}
